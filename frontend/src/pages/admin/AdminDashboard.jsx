                ...
                <div className=" flex flex-col px-20 gap-4">
                    {
                        loading ? (
                            ...
                            filteredJob.map((j) => (
                                <div
                                    key={j._id}
                                    className="flex flex-col border shadow-sm shadow-black p-4 mt-2 rounded w-full  hover:bg-gray-100 text-white hover:text-black"
                                >
                                    ...
                                    <div className="mt-2">
                                        <Link
                                            ...
                                            className="underline italic hover:font-bold"
                                        >
                                            View Applicants
                                        </Link>
